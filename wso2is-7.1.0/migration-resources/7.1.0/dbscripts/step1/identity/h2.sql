...
INSERT INTO MIGRATION_STATUS(is_version, locked_by, status, lock_acquired_at, expires_at) values ('7.1.0', NULL, 'NOT-STARTED', NULL, NULL);
INSERT INTO MIGRATOR_PROGRESS(IS_VERSION, STATUS, CURRENT_MIGRATOR, CURRENT_TENANT, LAST_COMPLETED_MIGRATOR, LAST_COMPLETED_TENANT) values ('7.1.0', 'NOT-STARTED', NULL, NULL, NULL, NULL);
